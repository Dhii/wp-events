...
namespace Dhii\EventManager\WordPress\FuncTest
{
    ...
    class RemoveWpHookCapableTraitTest extends TestCase
    {
        ...
        public function testRemoveWpHook()
        {
            ...
            self::$fnMocks->shouldReceive('remove_filter')
...
namespace Dhii\EventManager\WordPress
{
    ...
    use Dhii\EventManager\WordPress\FuncTest\RemoveWpHookCapableTraitTest;

    function remove_filter($name, $handler, $priority)
    {
        RemoveWpHookCapableTraitTest::$fnMocks->remove_filter($name, $handler, $priority);
    }
}
