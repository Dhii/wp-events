...
namespace Dhii\EventManager\WordPress\FuncTest
{
    ...
    class AddWpHookCapableTraitTest extends TestCase
    {
        ...
        /**
         * Function mock objects.
         *
         * @since [*next-version*]
         *
         * @var MockInterface
         */
        public static $fnMocks;
        ...
        public function testAddWpHook()
        {
            ...
            self::$fnMocks->shouldReceive('add_filter')
                          ->with($nName, $handler, $nPriority, $nNumArgs)
                          ->once();
        ...
        public function testAddWpHookUseDefaultPriority()
        {
            ...
            self::$fnMocks->shouldReceive('add_filter')
                          ->with($nName, $handler, $defPriority, $nNumArgs)
                          ->once();
        ...
        public function testAddWpHookUseDefaultNumArgs()
        {
            ...
            self::$fnMocks->shouldReceive('add_filter')
                          ->with($nName, $handler, $nPriority, 1)
                          ->once();
...
namespace Dhii\EventManager\WordPress
{
    ...
    use Dhii\EventManager\WordPress\FuncTest\AddWpHookCapableTraitTest;

    function add_filter($name, $handler, $priority, $numArgs)
    {
        AddWpHookCapableTraitTest::$fnMocks->add_filter($name, $handler, $priority, $numArgs);
    }
}
